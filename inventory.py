...
class Axe(item.Weapon):
    def __init__(self):
        super(Axe, self).__init__(name="Axe", description=[""], bonus={"DEX" : -2}, damage=10, dices=1, location=None)

class LeatherArmor(item.Armor):
    def __init__(self):
        super(LeatherArmor, self).__init__(name="Leather Armor", description=["A leather armor"], bonus={"RES" : 2}, location=None)

class ChainArmor(item.Armor):
    def __init__(self, name="Chain Armor", description=["A chain armor"], bonus={"DEX" : -2, "RES" : 6}, location=None):
...
class FuryArmor(item.Armor):
    def __init__(self, name="Fury Armor", description=["A cringeworthy armor"], bonus={"RES" : 2, "BTH" : -1}, location=None):
...
class GreatAxe(item.Weapon):
    def __init__(self, name="Great Axe", description=["Just a big ass axe"], bonus={"DEX" : -2}, dices=3, damage=4, location=None):
...
class BeltOfGiants(item.Belt):
    def __init__(self, name="Belt of Giants", description=["Legendary belt crafted by the giants (although is very small)"], bonus={"DEX" : -2, "STR" : +4}, location=None):
...
class HelmOfContinency(item.Helm):
    def __init__(self, name="Helm of Continency", description=["A monk cast helm"], bonus={"BTH" : +1, "RES" : +2}, location=None):
...
class JacksonHelm(item.Helm):
    def __init__(self, name="Jackson Helm", description=["Helm that belonged to Jackson", "Part of Jackson set"], bonus={"RES" : 1}, location=None):
...
class JacksonBoots(item.Boots):
    def __init__(self, name="Jackson Boots", description=["Boots that belonged to Jackson", "Part of Jackson set"], bonus={"DEX" : 1}, location=None):
