...
class Master(object):
    ...
    def quick_protagonist(self, generation=0):
        BTH, RES, MAG, DEX, STR = [5, 12,14,11,13]
        HP = 6+ 2* random.randint(0,3)
        data = {"name" : random.sample(RANDOM_NAMES, 1)[0], "id" : uuid.uuid4(), "BTH" : BTH + 6, "RES" : RES, "MAG" : MAG, "HP" : HP, "DEX" : DEX + 6, "STR" : STR + 6}
    ...
    def create_player(self, name, chars):
        ...
        data = {"name" : name, "id" : uuid.uuid4(), "BTH" : chars["BTH"], "RES" : chars["RES"], "MAG" : chars["MAG"], "HP" : chars["HP"], 
        "DEX" : chars["DEX"], "STR" : chars["STR"]}
    ...
    def update(self, *args):
        ...
        try:
            ...
            sys.exit()
        WORK_MODIFIER = 1
        self.protagonist.update(path,  GAME_SPEED * DELTATIME * WORK_MODIFIER)
    ...
    def tire(self, index):
        ...
        self.protagonist.players[index].HP_damage += 10
